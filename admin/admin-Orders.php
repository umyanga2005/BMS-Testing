...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    if ($orderId > 0) {
        ...
        $stmt = $mysqli->prepare("DELETE FROM tg_orders WHERE orderId = ?");
...
$totalOrdersSql = "SELECT COUNT(*) AS total FROM tg_orders";
...
<div class="container customers">
    ...
    <aside class="customers">
        ...
        <div class="sidebar">
            ...
            <a href="<?php echo ADMIN_URL; ?>admin-Orders" class="active">
